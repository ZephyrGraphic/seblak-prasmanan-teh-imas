      ...
      <main className="flex-1 pb-24">
        ...
        <div className="@container">
          <div className="@[480px]:px-4 @[480px]:py-3">
            <div
              ...
              style={{
                backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0) 50%, rgba(0,0,0,0.8) 100%), url("/images/outlet.png")`,
              }}
            >
              <div className="p-6">
                <span className="inline-block bg-primary text-white text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-wider">
                  📍 Cibolang Kaler, Sukabumi
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="px-6">
          <p className="text-[#181411]/70 dark:text-white/70 text-base font-medium leading-relaxed text-center">
            Pilih topping sesukamu dari 30+ pilihan. Level pedas juara yang
            bikin nagih!
          </p>
        </div>

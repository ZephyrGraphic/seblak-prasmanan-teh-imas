...
export default function AdminDashboard() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "PENDING":
        return (
          <span className="px-2 py-1 text-[10px] font-bold uppercase rounded bg-yellow-100 text-yellow-700">
            Pending
          </span>
        );
      case "PREPARING":
      ...
      case "READY":
        return (
          <span className="px-2 py-1 text-[10px] font-bold uppercase rounded bg-green-100 text-green-700">
            Siap
          </span>
        );
      default:
    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark pb-20">
      ...
      <section className="p-4 flex gap-3">
        <div className="flex-1 bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10">
          ...
          <p className="text-3xl font-extrabold text-[#181411] dark:text-white">
            {orders.length}
          </p>
        </div>
        <div className="flex-1 bg-white dark:bg-white/5 p-4 rounded-xl border border-gray-200 dark:border-white/10">
            ...
            >
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  <div>
                    <p className="text-lg font-extrabold text-[#181411] dark:text-white">
                      {order.queueNumber}
                    </p>

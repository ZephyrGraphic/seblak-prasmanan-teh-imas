      ...
      <main className="p-4 space-y-6">
        ...
        <section className="grid grid-cols-2 gap-3">
          <button
            ...
            className="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 p-4 flex flex-col items-center gap-2"
          >
          ...
          <div className="p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Izinkan pelanggan membuat pesanan
              </p>
            </div>
            <button
        ...
        <section className="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden">
          ...
          <div className="p-4 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-gray-500">
                Sebutkan nama pemesan (Text-to-Speech)
              </p>
            </div>
            <button
        ...
        <section className="bg-white dark:bg-white/5 rounded-xl border border-gray-200 dark:border-white/10 overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            <div>
              ...
              <p className="font-mono font-bold text-[#181411] dark:text-white">

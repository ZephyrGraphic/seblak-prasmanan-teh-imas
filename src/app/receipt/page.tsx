...
function ReceiptContent() {
  ...
  useEffect(() => {
    ...
    // Poll every 5 seconds for status updates (only if not completed/cancelled)
      ...
      <main className="flex-1 p-6 flex flex-col items-center">
        ...
        >
          ...
          <div className="pt-8 px-6 text-center w-full">
            ...
            <h1 className="text-[18px] font-extrabold leading-tight tracking-[-0.015em] uppercase">
              Seblak Prasmanan
            </h1>
            <h2
              style={{ color: "#f47b25" }}
              className="text-lg font-bold italic -mt-1 uppercase"
            >
              Teh Imas
            </h2>
          </div>
          ...
          <div className="px-6 py-4 w-full">
            <div
              style={{ borderColor: "#e5e7eb", backgroundColor: "#fdfaf8" }}
              className="w-full border-2 border-dashed rounded-xl p-4 flex flex-col items-center"
            >
              <p
                style={{ color: "#8a7260" }}
          ...
          {order?.status && (
            <div className="px-6 pb-2 w-full">
              <div
                style={{
                  backgroundColor:
                    STATUS_CONFIG[order.status]?.bgColor || "#f3f4f6",
                  borderColor: STATUS_CONFIG[order.status]?.color || "#9ca3af",
                }}
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p style={{ color: "#6b7280" }} className="text-[10px]">
                    {order.status === "PENDING" &&
                      "Pesanan Anda sedang dalam antrian"}
                    {order.status === "PREPARING" &&
                      "Koki sedang meracik seblak Anda"}
                    {order.status === "READY" &&
          ...
          <div className="px-6 space-y-2 w-full">
            ...
            <div className="flex justify-between gap-x-6">
              ...
              <span
                style={{ backgroundColor: "#f47b25", color: "#ffffff" }}
            ...
            {order?.items.map((bowl, idx) => (
              <div key={idx}>
                ...
                >
                  ...
                  <div
                    style={{ color: "#9ca3af" }}
                    className="flex justify-between text-sm text-[10px]"
                  >
                    <span>
                  ...
                  <div
                    style={{ borderColor: "#e5e7eb" }}
                    className="flex justify-between text-sm pt-1 border-t border-dashed mt-1"
                  >
          ...
          <div className="px-6 py-6 mt-4 w-full">
            <div
              style={{ borderColor: "#e5e7eb" }}
              className="border-t-2 border-dashed pt-4 space-y-2"
            >
